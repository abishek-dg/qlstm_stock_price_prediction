...
log_file_path = os.path.join(base_dir, "log_qlstm_300ep_10qb_128hs_2nl.txt")
...
os.makedirs("models_qlstm_300ep_10qb_128hs_2nl", exist_ok=True)
os.makedirs("images_qlstm_300ep_10qb_128hs_2nl", exist_ok=True)
...
def plot_train_test_split(X_train, X_test, y_train, y_test,
                          base_dir=".", image_dir="images_qlstm_300ep_10qb_128hs_2nl",
                          filename="train_test_split_plot_qlstm_300ep_10qb_128hs_2nl.png"):
    try:
...
try:
    ...
    try:
        ...
        circuit_drawer(qc_blocks, output='mpl', filename=os.path.join(base_dir, "images_qlstm_300ep_10qb_128hs_2nl", "qlstm_architecture_blocks_300ep_10qb_128hs_2nl.png"))

        detailed_qc = QuantumCircuit(num_qubits)
        detailed_qc.compose(feature_map, inplace=True)
        detailed_qc.compose(ansatz, inplace=True)
        circuit_drawer(detailed_qc.decompose(), output='mpl', filename=os.path.join(base_dir, "images_qlstm_300ep_10qb_128hs_2nl", "featuremap_ansatz_internal_gates_qlstm_300ep_10qb_128hs_2nl.png"))
...
try:
    # Draw neural network
    def draw_network(layer_sizes, layer_labels, save_path="images_qlstm_300ep_10qb_128hs_2nl/neural_network_qlstm_300ep_10qb_128hs_2nl.png"):
...
try:
    ...
    model_dir = "models_qlstm_300ep_10qb_128hs_2nl"
    os.makedirs(model_dir, exist_ok=True)
    model_path = os.path.join(model_dir, "qlstm_model_300ep_10qb_128hs_2nl.pt")
...
try:
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig(os.path.join(base_dir, "images_qlstm_300ep_10qb_128hs_2nl", "training_loss_300ep_10qb_128hs_2nl.png"), bbox_inches='tight', dpi=300)
    plt.close()
...
try:
    ...
    plt.ylabel('Price')
    plt.legend()
    plt.savefig("images_qlstm_300ep_10qb_128hs_2nl/aapl_prediction_qlstm_300ep_10qb_128hs_2nl.png", bbox_inches='tight', dpi=300)
    plt.close()
...
try:
    ...
    eval_data = {
        'Title': ['qlstm_300ep_10qb_128hs_2nl'],
        'Accuracy': [accuracy],
        'Precision': [precision],
        'Recall': [recall],
        'F1': [f1],
    ...
    csv_path = os.path.join(base_dir, "qlstm_architecture_network_300ep_10qb_128hs_2nl.csv")
    ...
    try:
        ...
        plot_confusion_matrix_matplotlib(cm, ['Negative', 'Positive'], os.path.join(base_dir, "images_qlstm_300ep_10qb_128hs_2nl", "confusion_qlstm_300ep_10qb_128hs_2nl.png"))
    except Exception as e:
    ...
    try:
        ...
        plt.savefig(os.path.join(base_dir, "images_qlstm_300ep_10qb_128hs_2nl", "precision_recall_curve_qlstm_300ep_10qb_128hs_2nl.png"), bbox_inches='tight', dpi=300)
        plt.close()
        ...
        plt.savefig(os.path.join(base_dir, "images_qlstm_300ep_10qb_128hs_2nl", "roc_curve_qlstm_300ep_10qb_128hs_2nl"), bbox_inches='tight', dpi=300)
        plt.close()
...
try:
    ...
    model.load_state_dict(torch.load("models_qlstm_300ep_10qb_128hs_2nl/qlstm_model_300ep_10qb_128hs_2nl.pt", map_location=device))
    model.eval()
    ...
    plt.legend()
    os.makedirs("images_qlstm_300ep_10qb_128hs_2nl", exist_ok=True)
    plt.savefig(f"images_qlstm_300ep_10qb_128hs_2nl/actual_vs_predicted_{num_days_to_predict}days.png", bbox_inches="tight", dpi=300)
    plt.close()
    logger.info(f" Saved: images_qlstm_300ep_10qb_128hs_2nl/actual_vs_predicted_{num_days_to_predict}days.png")
    ...
    plt.legend()
    plt.savefig(f"images_qlstm_300ep_10qb_128hs_2nl/predicted_only_{num_days_to_predict}days_aligned.png", bbox_inches="tight", dpi=300)
    plt.close()
    logger.info(f"Saved: images_qlstm_300ep_10qb_128hs_2nl/predicted_only_{num_days_to_predict}days_aligned.png")
