...
log_file_path = os.path.join(base_dir, "log_qlstm_4qb_2nl_64hs_300ep.txt")
...
os.makedirs("models_qlstm_4qb_2nl_64hs_300ep", exist_ok=True)
os.makedirs("images_qlstm_4qb_2nl_64hs_300ep", exist_ok=True)
...
def plot_train_test_split(X_train, X_test, y_train, y_test,
                          base_dir=".", image_dir="images_qlstm_4qb_2nl_64hs_300ep",
                          filename="train_test_split_plot_qlstm_4qb_2nl_64hs_300ep.png"):
    try:
...
try:
    ...
    try:
        ...
        circuit_drawer(qc_blocks, output='mpl', filename=os.path.join(base_dir, "images_qlstm_4qb_2nl_64hs_300ep", "qlstm_architecture_blocks_4qb_2nl_64hs_300ep.png"))

        detailed_qc = QuantumCircuit(num_qubits)
        detailed_qc.compose(feature_map, inplace=True)
        detailed_qc.compose(ansatz, inplace=True)
        circuit_drawer(detailed_qc.decompose(), output='mpl', filename=os.path.join(base_dir, "images_qlstm_4qb_2nl_64hs_300ep", "featuremap_ansatz_internal_gates_qlstm_4qb_2nl_64hs_300ep.png"))
...
try:
    # Draw neural network
    def draw_network(layer_sizes, layer_labels, save_path="images_qlstm_4qb_2nl_64hs_300ep/neural_network_qlstm_4qb_2nl_64hs_300ep.png"):
...
try:
    ...
    model_dir = "models_qlstm_4qb_2nl_64hs_300ep"
    os.makedirs(model_dir, exist_ok=True)
    model_path = os.path.join(model_dir, "qlstm_model_4qb_2nl_64hs_300ep.pt")
...
try:
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig(os.path.join(base_dir, "images_qlstm_4qb_2nl_64hs_300ep", "training_loss_4qb_2nl_64hs_300ep.png"), bbox_inches='tight', dpi=300)
    plt.close()
...
try:
    ...
    plt.ylabel('Price')
    plt.legend()
    plt.savefig("images_qlstm_4qb_2nl_64hs_300ep/aapl_prediction_qlstm_4qb_2nl_64hs_300ep.png", bbox_inches='tight', dpi=300)
    plt.close()
...
try:
    ...
    eval_data = {
        'Title': ['qlstm_4qb_2nl_64hs_300ep'],
        'Accuracy': [accuracy],
        'Precision': [precision],
        'Recall': [recall],
        'F1': [f1],
    ...
    csv_path = os.path.join(base_dir, "qlstm_architecture_network_4qb_2nl_64hs_300ep.csv")
    ...
    try:
        ...
        plot_confusion_matrix_matplotlib(cm, ['Negative', 'Positive'], os.path.join(base_dir, "images_qlstm_4qb_2nl_64hs_300ep", "confusion_qlstm_4qb_2nl_64hs_300ep.png"))
    except Exception as e:
    ...
    try:
        ...
        plt.savefig(os.path.join(base_dir, "images_qlstm_4qb_2nl_64hs_300ep", "precision_recall_curve_qlstm_4qb_2nl_64hs_300ep.png"), bbox_inches='tight', dpi=300)
        plt.close()
        ...
        plt.savefig(os.path.join(base_dir, "images_qlstm_4qb_2nl_64hs_300ep", "roc_curve_qlstm_4qb_2nl_64hs_300ep"), bbox_inches='tight', dpi=300)
        plt.close()
...
try:
    ...
    model.load_state_dict(torch.load("models_qlstm_4qb_2nl_64hs_300ep/qlstm_model_4qb_2nl_64hs_300ep.pt", map_location=device))
    model.eval()
    ...
    plt.legend()
    os.makedirs("images_qlstm_4qb_2nl_64hs_300ep", exist_ok=True)
    plt.savefig(f"images_qlstm_4qb_2nl_64hs_300ep/actual_vs_predicted_{num_days_to_predict}days.png", bbox_inches="tight", dpi=300)
    plt.close()
    logger.info(f" Saved: images_qlstm_4qb_2nl_64hs_300ep/actual_vs_predicted_{num_days_to_predict}days.png")
    ...
    plt.legend()
    plt.savefig(f"images_qlstm_4qb_2nl_64hs_300ep/predicted_only_{num_days_to_predict}days_aligned.png", bbox_inches="tight", dpi=300)
    plt.close()
    logger.info(f"Saved: images_qlstm_4qb_2nl_64hs_300ep/predicted_only_{num_days_to_predict}days_aligned.png")
